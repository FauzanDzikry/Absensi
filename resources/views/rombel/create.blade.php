    ...
    <div class="card">
            <form method="post" action="/rombel">
                <div class="card-title">
                    <h3 class="text-center">Rombel</h3>
                </div>
                <hr>
                @csrf
                ...
                <div class="card-body card-block">
                    <div class="mb-3">
                        ...
                        <input type="text" name="rombel" value="{{old('rombel')}}" class="form-control @error('rombel') is-invalid @enderror" placeholder="Masukan Nama Rombel">
                        @error('rombel')
