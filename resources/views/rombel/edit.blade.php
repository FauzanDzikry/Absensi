                ...
                <div class="card-header"><strong>Edit</strong><small> Data</small></div>
                    <div class="card-body card-block">
                        <div class="mb-3">
                          ...
                          <input type="text" name="rombel" value="{{$rombel->rombel}}" class="form-control @error('rombel') is-invalid @enderror" placeholder="Masukan Nama Rombel">
                          @error('rombel')
